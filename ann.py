...
classifier_1.add(Dense(output_dim = 6, init = 'uniform', activation = 'relu', input_dim = 11))

# Adding the second hidden layer
classifier_1.add(Dense(output_dim = 6, init = 'uniform', activation = 'relu'))
